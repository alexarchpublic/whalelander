        ...
        >
          <div className={
            isVideo(gift.images[indices[i]])
              ? "aspect-video w-full max-w-xs mb-4 overflow-hidden rounded-lg flex items-center justify-center bg-gray-50"
              : "aspect-square w-full max-w-xs mb-4 overflow-hidden rounded-lg flex items-center justify-center bg-gray-50"
          }>
            {isVideo(gift.images[indices[i]]) ? (
              <video
